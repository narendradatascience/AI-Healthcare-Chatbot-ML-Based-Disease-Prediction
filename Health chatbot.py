...
def chatbot():
    ...
    # Initial symptoms
    symptoms_input = input(" Describe your symoptoms in a sentance (e.g, 'I have fever and stomach pain'): ")
    ...
    pre_exist = input("Do you have any pre_existing condition (e.g., diabetes, hypertension)?: ")
    ...
    disease_row = traning[traning['prognosis'] == disease].iloc[0][:-1]
    disease_symptoms = list(disease_row[disease_row == 1].index)
    ...
    print("\nThank you for using the chatbot. Whising you good health,", name + "!")
